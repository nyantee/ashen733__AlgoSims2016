...
void ofApp::setup(){
    ...
    gui.add(time.setup("time", .5, .25, 30));
    ...
    ofDisableArbTex();
    ofLoadImage(texture, "img2.jpg");
    ofLoadImage(normal, "img2.jpg");
    shader.load("shader.vert", "shader.frag");
    
    //use the same photo and the shaders settings find the darkest and lightest spots
...
void ofApp::draw(){
    ...
    shader.setUniform1f("u_time", ofGetElapsedTimef()*time);
