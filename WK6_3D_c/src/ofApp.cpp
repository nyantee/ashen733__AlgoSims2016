...
void ofApp::setup(){
    ...
    car1.color = ofColor(0,255,100);
    car2.color = ofColor(255,0,255);
    car3.color = ofColor(255,200,255);
    car4.color = ofColor(200,100,50);
    car5.color = ofColor(50,100,200);
...
void ofApp::update(){
    ...
    if( car1.getPosition().distance( car2.getPosition() ) < area ){
        car1.color = ofColor(255,100,0);
        car2.color = ofColor(100,0,255);
